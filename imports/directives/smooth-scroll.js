    ...
    var smoothScroll = function (element, options) {
        ...
        setTimeout(function () {
            ...
            var stopAnimation = function () {
                ...
                if (containerPresent) {
                    if (direction == 'vertical') {
                        scrollDepth = container.scrollHeight;
                        internalDepth = container.clientHeight + currentLocation;
                    } else if (direction == 'horizontal') {
                    ...
                    if (direction == 'vertical') {
                        scrollDepth = document.body.scrollheight;
                        internalDepth = window.innerHeight + currentLocation;
                    } else if (direction == 'horizontal') {
